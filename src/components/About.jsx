  ...
  return (
    ...
    ><div className="w-full flex flex-col items-start">
      ...
      <div className="md:w-[40%] w-full">
        ...
        <p className="text-[2rem] source-serif-4 mt-5 text-blue-200 md:text-3xl mb-6 Merriweather">A passionate web developer driven by the vision to make a lasting impact in the tech world through innovative, real-life problem-solving web applications.</p>
      </div>
      <div className="w-full lg:w-[40%] karla font-medium bg-clip-text bg-gradient-to-bl from-white via-gray-700 to-white text-transparent animation">
        ...
        <p className="text-lg md:xl mt-5">Recently, I’ve been expanding my skills into backend development, exploring technologies like <b className="text-blue-200 cormorant-font">Node.js</b>, <b className="text-blue-200 cormorant-font">Express</b>, and <b className="text-blue-200 cormorant-font">MongoDB</b> to better understand how data flows behind the scenes. This journey helps me build more complete, scalable, and efficient web applications that deliver both great design and powerful functionality.</p>
      </div>
    </div>
    <style >
      {`
